...
| `DesignFlow` | `components/DesignFlow.tsx` | Full-screen guiado con 2 steppers (selección y placement); mock interno draggable (frente/espalda); prop `onAdd(designs)` con los confirmados |
