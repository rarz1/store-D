...
- **SQL requerido en Supabase (pendiente de correr por el usuario)**: `alter table site_settings add column collections_banner_url text not null default '';` — hasta no correrlo, guardar settings desde admin fallará con PGRST204.
